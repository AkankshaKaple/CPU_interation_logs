...
def count_lines(name,num):
    file = open(name)
    count = len(file.readlines())/num
    file.close()
    return count
...
mouse_file = "/home/{}/Music/.cpu/mouse_log.txt".format(user)
keyboard_file = "/home/{}/Music/.cpu/keyboard_log.txt".format(user)
